...
// Javascript for stacks_in_26959_page12
// ---------------------------------------------------------------------

// Each stack has its own object with its own namespace.  The name of
// that object is the same as the stack's id.
stacks.stacks_in_26959_page12 = {};

// A closure is defined and assigned to the stack's object.  The object
// is also passed in as 'stack' which gives you a shorthand for referring
// to this object from elsewhere.
stacks.stacks_in_26959_page12 = (function(stack) {
 ...
 var opacity=100,opacityBottom=85,hoverOpacity=15,subNavIndex=1,divide=0,zoneDivider=0,fullWidthMenu='full-width',scope='all',style='solid',menuAlign='right',baseColor='#FFFFFF',baseColorTop='#737373',hoverColor='#FFFFFF',styleActive='styleActive'==='styleActive'?true:false,rwmenu='rw'==='rw'?true:false,magellan='rw'==='magellan'?true:false,menuItems='#stacks_in_26959_page12 ul:not(.title-area) li:hover:not(.has-dropdown) > a:not(.button)',dropdowns='#stacks_in_26959_page12 ul:not(.title-area) li.has-dropdown';if(opacity<100||style=="faded"){$.glass({colors:[baseColor,baseColorTop],gradient:style,opacity:[opacity,opacityBottom],selector:'#stacks_in_26959_page12 .top-bar-wrapper'});$.glass({colors:[baseColor],opacity:[opacity],selector:'#stacks_in_26959_page12 ul:not(.title-area) ul.dropdown'});}
if(hoverOpacity<100){if(styleActive){var active=magellan?'#stacks_in_26959_page12 .top-bar-wrapper.styleActive .magellanList li.active > a':'#stacks_in_26959_page12 .top-bar-wrapper.styleActive li.active > a';$.glass({colors:[hoverColor],opacity:[hoverOpacity],selector:active});}
...
$(document).ready(function(){var stack=$('#stacks_in_26959_page12');stack.parent().css({overflow:'visible'});$('.top-bar-section:not(.menu-magellan):not(.menu-none)',stack).rwflexnav({scope:scope,subNavIndex:subNavIndex,divide:divide});if(magellan){if(divide)$('ul.magellanList',stack).divideNav();$('.magellanList li',stack).each(function(){var id=$(this).data('magellan-arrival');$('a',this).attr('href','#'+id);});}
...
// Javascript for stacks_in_26980_page12
// ---------------------------------------------------------------------

// Each stack has its own object with its own namespace.  The name of
// that object is the same as the stack's id.
stacks.stacks_in_26980_page12 = {};

// A closure is defined and assigned to the stack's object.  The object
// is also passed in as 'stack' which gives you a shorthand for referring
// to this object from elsewhere.
stacks.stacks_in_26980_page12 = (function(stack) {
 ...
 var opacity=100,opacityBottom=85,hoverOpacity=15,subNavIndex=1,divide=0,zoneDivider=0,fullWidthMenu='full-width',scope='all',style='solid',menuAlign='right',baseColor='#FFFFFF',baseColorTop='#737373',hoverColor='#FFFFFF',styleActive='styleActive'==='styleActive'?true:false,rwmenu='rw'==='rw'?true:false,magellan='rw'==='magellan'?true:false,menuItems='#stacks_in_26980_page12 ul:not(.title-area) li:hover:not(.has-dropdown) > a:not(.button)',dropdowns='#stacks_in_26980_page12 ul:not(.title-area) li.has-dropdown';if(opacity<100||style=="faded"){$.glass({colors:[baseColor,baseColorTop],gradient:style,opacity:[opacity,opacityBottom],selector:'#stacks_in_26980_page12 .top-bar-wrapper'});$.glass({colors:[baseColor],opacity:[opacity],selector:'#stacks_in_26980_page12 ul:not(.title-area) ul.dropdown'});}
if(hoverOpacity<100){if(styleActive){var active=magellan?'#stacks_in_26980_page12 .top-bar-wrapper.styleActive .magellanList li.active > a':'#stacks_in_26980_page12 .top-bar-wrapper.styleActive li.active > a';$.glass({colors:[hoverColor],opacity:[hoverOpacity],selector:active});}
$.glass({colors:[hoverColor],opacity:[hoverOpacity],selector:menuItems});$.glass({colors:[hoverColor],opacity:[hoverOpacity],selector:dropdowns+'> a.hovered:not(.button)'});}
$(document).ready(function(){var stack=$('#stacks_in_26980_page12');stack.parent().css({overflow:'visible'});$('.top-bar-section:not(.menu-magellan):not(.menu-none)',stack).rwflexnav({scope:scope,subNavIndex:subNavIndex,divide:divide});if(magellan){if(divide)$('ul.magellanList',stack).divideNav();$('.magellanList li',stack).each(function(){var id=$(this).data('magellan-arrival');$('a',this).attr('href','#'+id);});}
if($('ul.zone',stack).exists()){if(zoneDivider)$('ul.zone',stack).divideNav();}
if($('.zone-align-left ul.zone',stack).exists()||!$('ul.zone',stack).exists()){$('ul.menu',stack).addClass(menuAlign);}
if(fullWidthMenu==='full-width'&&menuAlign==='centered'){var calcMenuItemWidth=function(){var items=$('.menu-align-centered ul.menu > li:not(.divider)',stack),dividers=$('.menu-align-centered ul.menu > li.divider',stack);if($('.top-bar .toggle-topbar',stack).is(':visible')){items.removeAttr('style');}
else{var count=items.length;if(count>0){var width=dividers.length>0?100/count-0.2:100/count;items.width(width+"%");}}};calcMenuItemWidth();$(window).on('resize',calcMenuItemWidth);}
...
// Javascript for stacks_in_27009_page12
// ---------------------------------------------------------------------

// Each stack has its own object with its own namespace.  The name of
// that object is the same as the stack's id.
stacks.stacks_in_27009_page12 = {};

// A closure is defined and assigned to the stack's object.  The object
// is also passed in as 'stack' which gives you a shorthand for referring
// to this object from elsewhere.
stacks.stacks_in_27009_page12 = (function(stack) {
 ...
 var opacity=100,opacityBottom=85,hoverOpacity=15,subNavIndex=1,divide=0,zoneDivider=0,fullWidthMenu='full-width',scope='all',style='solid',menuAlign='right',baseColor='#FFFFFF',baseColorTop='#737373',hoverColor='#FFFFFF',styleActive='styleActive'==='styleActive'?true:false,rwmenu='rw'==='rw'?true:false,magellan='rw'==='magellan'?true:false,menuItems='#stacks_in_27009_page12 ul:not(.title-area) li:hover:not(.has-dropdown) > a:not(.button)',dropdowns='#stacks_in_27009_page12 ul:not(.title-area) li.has-dropdown';if(opacity<100||style=="faded"){$.glass({colors:[baseColor,baseColorTop],gradient:style,opacity:[opacity,opacityBottom],selector:'#stacks_in_27009_page12 .top-bar-wrapper'});$.glass({colors:[baseColor],opacity:[opacity],selector:'#stacks_in_27009_page12 ul:not(.title-area) ul.dropdown'});}
if(hoverOpacity<100){if(styleActive){var active=magellan?'#stacks_in_27009_page12 .top-bar-wrapper.styleActive .magellanList li.active > a':'#stacks_in_27009_page12 .top-bar-wrapper.styleActive li.active > a';$.glass({colors:[hoverColor],opacity:[hoverOpacity],selector:active});}
$.glass({colors:[hoverColor],opacity:[hoverOpacity],selector:menuItems});$.glass({colors:[hoverColor],opacity:[hoverOpacity],selector:dropdowns+'> a.hovered:not(.button)'});}
$(document).ready(function(){var stack=$('#stacks_in_27009_page12');stack.parent().css({overflow:'visible'});$('.top-bar-section:not(.menu-magellan):not(.menu-none)',stack).rwflexnav({scope:scope,subNavIndex:subNavIndex,divide:divide});if(magellan){if(divide)$('ul.magellanList',stack).divideNav();$('.magellanList li',stack).each(function(){var id=$(this).data('magellan-arrival');$('a',this).attr('href','#'+id);});}
if($('ul.zone',stack).exists()){if(zoneDivider)$('ul.zone',stack).divideNav();}
if($('.zone-align-left ul.zone',stack).exists()||!$('ul.zone',stack).exists()){$('ul.menu',stack).addClass(menuAlign);}
if(fullWidthMenu==='full-width'&&menuAlign==='centered'){var calcMenuItemWidth=function(){var items=$('.menu-align-centered ul.menu > li:not(.divider)',stack),dividers=$('.menu-align-centered ul.menu > li.divider',stack);if($('.top-bar .toggle-topbar',stack).is(':visible')){items.removeAttr('style');}
else{var count=items.length;if(count>0){var width=dividers.length>0?100/count-0.2:100/count;items.width(width+"%");}}};calcMenuItemWidth();$(window).on('resize',calcMenuItemWidth);}
...
// Javascript for stacks_in_6944_page12
// ---------------------------------------------------------------------

// Each stack has its own object with its own namespace.  The name of
// that object is the same as the stack's id.
stacks.stacks_in_6944_page12 = {};

// A closure is defined and assigned to the stack's object.  The object
// is also passed in as 'stack' which gives you a shorthand for referring
// to this object from elsewhere.
stacks.stacks_in_6944_page12 = (function(stack) {
...
// Javascript for stacks_in_7010_page12
// ---------------------------------------------------------------------

// Each stack has its own object with its own namespace.  The name of
// that object is the same as the stack's id.
stacks.stacks_in_7010_page12 = {};

// A closure is defined and assigned to the stack's object.  The object
// is also passed in as 'stack' which gives you a shorthand for referring
// to this object from elsewhere.
stacks.stacks_in_7010_page12 = (function(stack) {
 ...
 $(document).ready(function(){var movingbox=$('#stacks_in_7010_page12 >.movingbox'),effect='slide',fade=(effect=='fade')?true:false,vertical=(effect=='slide-vert')?true:false,initial=1-1,sync=0,autoplay=true,b1conf={breakpoint:480,settings:{slidesToShow:(effect=='fade')?1:1,slidesToScroll:1,initialSlide:1-1,centerMode:false,centerPadding:'%',dots:true,arrows:false}},b2conf={breakpoint:660,settings:{slidesToShow:(effect=='fade')?1:1,slidesToScroll:1,initialSlide:1-1,centerMode:false,centerPadding:'%',dots:true,arrows:false}},breakpoints=[];if(window.debug===true)autoplay=false;var slideTitles=[];movingbox.children().each(function(index){var title=index+1;var headers=$(this).find('h1,h2,h3,h4,h5,h6');if(headers.exists()){$.debug('Slide Headers',headers);title=headers.first().text().replace(/\s+/g,'-').toLowerCase();}
else{var images=$(this).find('img');if(images.exists()){$.debug('Slide Images',images);alt=images.first().attr('alt').replace(/\s+/g,'-').toLowerCase();title=alt!==''?alt:title;}}
$.debug('Slide Title #'+index+':'+title);slideTitles.push(title);});$.debug('All Slide Titles:',slideTitles);if(true)breakpoints.push(b1conf);if(false)breakpoints.push(b2conf);if(false){$('>.stacks_out',movingbox).each(function(){$(this).width($(this).width());});}
movingbox.slick({asNavFor:(0)?'#movingbox2':null,adaptiveHeight:false,variableWidth:false,accessibility:true,focusOnSelect:true,lazyLoad:'progressive',autoplay:autoplay,autoplaySpeed:4000,arrows:false,useCSS:true,cssEase:'ease',dots:true,draggable:true,fade:fade,vertical:vertical,infinite:true,pauseOnHover:false,pauseOnDotsHover:false,speed:500,swipe:true,touchMove:true,touchThreshold:5,rtl:false,slide:'.stacks_out',initialSlide:1-1,slidesToShow:(effect=='fade')?1:1,slidesToScroll:1,centerMode:false,centerPadding:'10.00%',responsive:breakpoints});var goToSlide=function(hash){var index=slideTitles.indexOf(hash);$.debug('Linking to hash '+hash+'with index '+index,slideTitles);if(index>=0){$.debug('Moving to slide with index '+index);movingbox.slickGoTo(parseInt(index)).slickPause();if(sync>0){$(window).load(function(){if($('#movingbox2').getSlick()){$('#movingbox2').slickGoTo(parseInt(index)).slickPause();}});}}};if(window.location.hash){var hash=location.hash.substring(1);goToSlide(hash);}
$('a.mb-slide').click(function(){var hash=$(this).attr('href').substring(1);goToSlide(hash);return false;});if($.isMobile()){$('.tap-target',movingbox).removeClass('hide').click(function(){$(this).hasClass('prev')?movingbox.slickPrev():movingbox.slickNext();})}});
...
// Javascript for stacks_in_1972_page12
// ---------------------------------------------------------------------

// Each stack has its own object with its own namespace.  The name of
// that object is the same as the stack's id.
stacks.stacks_in_1972_page12 = {};

// A closure is defined and assigned to the stack's object.  The object
// is also passed in as 'stack' which gives you a shorthand for referring
// to this object from elsewhere.
stacks.stacks_in_1972_page12 = (function(stack) {
...
(function(b){var a=function(d){var c=b(this);if(c.data("resizetimer")){window.clearTimeout(c.data("resizetimer"))}c.data("resizetimer",window.setTimeout(function(){c.trigger("afterresize")},300))};b.event.special.afterresize={add:function(c){b(this).bind("resize",a);var d=c.handler;c.handler=function(e){return d.apply(this,arguments)}},remove:function(c){b(this).unbind("resize",a)}};b.fn.extend({afterresize:function(c){if(b.isFunction(c)){b(this).bind("afterresize",c)}else{b(this).trigger("afterresize")}return this}})})(jQuery);$(window).load(function(){function build_mask_stacks_in_1972_page12(){var box_width=$('#stacks_in_1972_page12 .boxgrid').width();var box_height=300;var back_height=$('#stacks_in_1972_page12 .boxgrid .back').height();var cover_height=$('#stacks_in_1972_page12 .boxgrid .cover').height();box_height=back_height;if(back_height>cover_height){$('#stacks_in_1972_page12 .boxgrid,#stacks_in_1972_page12 .boxgrid .cover').height(back_height);}
else{box_height=cover_height;$('#stacks_in_1972_page12 .boxgrid,#stacks_in_1972_page12 .boxgrid .back').height(cover_height);}}
build_mask_stacks_in_1972_page12();if(typeof(orientationEvent)==undefined){var orientationEvent=0;}
$(window).bind(orientationEvent,build_mask_stacks_in_1972_page12).bind('resize',build_mask_stacks_in_1972_page12).afterresize(build_mask_stacks_in_1972_page12);});

	return stack;
})(stacks.stacks_in_1972_page12);


// Javascript for stacks_in_7078_page12
// ---------------------------------------------------------------------

// Each stack has its own object with its own namespace.  The name of
// that object is the same as the stack's id.
stacks.stacks_in_7078_page12 = {};

// A closure is defined and assigned to the stack's object.  The object
// is also passed in as 'stack' which gives you a shorthand for referring
// to this object from elsewhere.
stacks.stacks_in_7078_page12 = (function(stack) {
 ...
 $(document).ready(function(){var movingbox=$('#stacks_in_7078_page12 >.movingbox'),effect='slide',fade=(effect=='fade')?true:false,vertical=(effect=='slide-vert')?true:false,initial=1-1,sync=0,autoplay=true,b1conf={breakpoint:480,settings:{slidesToShow:(effect=='fade')?1:1,slidesToScroll:1,initialSlide:1-1,centerMode:false,centerPadding:'%',dots:true,arrows:false}},b2conf={breakpoint:660,settings:{slidesToShow:(effect=='fade')?1:1,slidesToScroll:1,initialSlide:1-1,centerMode:false,centerPadding:'%',dots:true,arrows:false}},breakpoints=[];if(window.debug===true)autoplay=false;var slideTitles=[];movingbox.children().each(function(index){var title=index+1;var headers=$(this).find('h1,h2,h3,h4,h5,h6');if(headers.exists()){$.debug('Slide Headers',headers);title=headers.first().text().replace(/\s+/g,'-').toLowerCase();}
else{var images=$(this).find('img');if(images.exists()){$.debug('Slide Images',images);alt=images.first().attr('alt').replace(/\s+/g,'-').toLowerCase();title=alt!==''?alt:title;}}
$.debug('Slide Title #'+index+':'+title);slideTitles.push(title);});$.debug('All Slide Titles:',slideTitles);if(true)breakpoints.push(b1conf);if(false)breakpoints.push(b2conf);if(false){$('>.stacks_out',movingbox).each(function(){$(this).width($(this).width());});}
movingbox.slick({asNavFor:(0)?'#movingbox2':null,adaptiveHeight:false,variableWidth:false,accessibility:true,focusOnSelect:true,lazyLoad:'progressive',autoplay:autoplay,autoplaySpeed:4000,arrows:false,useCSS:true,cssEase:'ease',dots:false,draggable:true,fade:fade,vertical:vertical,infinite:true,pauseOnHover:false,pauseOnDotsHover:false,speed:500,swipe:true,touchMove:true,touchThreshold:5,rtl:false,slide:'.stacks_out',initialSlide:1-1,slidesToShow:(effect=='fade')?1:1,slidesToScroll:1,centerMode:false,centerPadding:'10.00%',responsive:breakpoints});var goToSlide=function(hash){var index=slideTitles.indexOf(hash);$.debug('Linking to hash '+hash+'with index '+index,slideTitles);if(index>=0){$.debug('Moving to slide with index '+index);movingbox.slickGoTo(parseInt(index)).slickPause();if(sync>0){$(window).load(function(){if($('#movingbox2').getSlick()){$('#movingbox2').slickGoTo(parseInt(index)).slickPause();}});}}};if(window.location.hash){var hash=location.hash.substring(1);goToSlide(hash);}
$('a.mb-slide').click(function(){var hash=$(this).attr('href').substring(1);goToSlide(hash);return false;});if($.isMobile()){$('.tap-target',movingbox).removeClass('hide').click(function(){$(this).hasClass('prev')?movingbox.slickPrev():movingbox.slickNext();})}});
...
// Javascript for stacks_in_24858_page12
// ---------------------------------------------------------------------

// Each stack has its own object with its own namespace.  The name of
// that object is the same as the stack's id.
stacks.stacks_in_24858_page12 = {};

// A closure is defined and assigned to the stack's object.  The object
// is also passed in as 'stack' which gives you a shorthand for referring
// to this object from elsewhere.
stacks.stacks_in_24858_page12 = (function(stack) {
 ...
 $(document).ready(function(){var stack=$('#stacks_in_24858_page12');$('ul',stack).first().addClass('side-nav custom').removeClass('dropdown');$('ul li',stack).each(function(){if($(this).find('ul').length==0)$(this).removeClass('has-dropdown');});$('ul.side-nav li a header',stack).unwrap().parent().addClass('heading');$('ul.side-nav li a label',stack).unwrap();$('ul.side-nav li a hr',stack).unwrap().parent().addClass('divider').html('');});
