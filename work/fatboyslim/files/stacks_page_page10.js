...
// Javascript for stacks_in_72084_page10
// ---------------------------------------------------------------------

// Each stack has its own object with its own namespace.  The name of
// that object is the same as the stack's id.
stacks.stacks_in_72084_page10 = {};

// A closure is defined and assigned to the stack's object.  The object
// is also passed in as 'stack' which gives you a shorthand for referring
// to this object from elsewhere.
stacks.stacks_in_72084_page10 = (function(stack) {
...
// Javascript for stacks_in_38957_page10
// ---------------------------------------------------------------------

// Each stack has its own object with its own namespace.  The name of
// that object is the same as the stack's id.
stacks.stacks_in_38957_page10 = {};

// A closure is defined and assigned to the stack's object.  The object
// is also passed in as 'stack' which gives you a shorthand for referring
// to this object from elsewhere.
stacks.stacks_in_38957_page10 = (function(stack) {
 ...
 var opacity=100,opacityBottom=85,hoverOpacity=15,subNavIndex=1,divide=0,zoneDivider=0,fullWidthMenu='full-width',scope='all',style='solid',menuAlign='right',baseColor='#FFFFFF',baseColorTop='#737373',hoverColor='#FFFFFF',styleActive='styleActive'==='styleActive'?true:false,rwmenu='rw'==='rw'?true:false,magellan='rw'==='magellan'?true:false,menuItems='#stacks_in_38957_page10 ul:not(.title-area) li:hover:not(.has-dropdown) > a:not(.button)',dropdowns='#stacks_in_38957_page10 ul:not(.title-area) li.has-dropdown';if(opacity<100||style=="faded"){$.glass({colors:[baseColor,baseColorTop],gradient:style,opacity:[opacity,opacityBottom],selector:'#stacks_in_38957_page10 .top-bar-wrapper'});$.glass({colors:[baseColor],opacity:[opacity],selector:'#stacks_in_38957_page10 ul:not(.title-area) ul.dropdown'});}
if(hoverOpacity<100){if(styleActive){var active=magellan?'#stacks_in_38957_page10 .top-bar-wrapper.styleActive .magellanList li.active > a':'#stacks_in_38957_page10 .top-bar-wrapper.styleActive li.active > a';$.glass({colors:[hoverColor],opacity:[hoverOpacity],selector:active});}
...
$(document).ready(function(){var stack=$('#stacks_in_38957_page10');stack.parent().css({overflow:'visible'});$('.top-bar-section:not(.menu-magellan):not(.menu-none)',stack).rwflexnav({scope:scope,subNavIndex:subNavIndex,divide:divide});if(magellan){if(divide)$('ul.magellanList',stack).divideNav();$('.magellanList li',stack).each(function(){var id=$(this).data('magellan-arrival');$('a',this).attr('href','#'+id);});}
...
// Javascript for stacks_in_38976_page10
// ---------------------------------------------------------------------

// Each stack has its own object with its own namespace.  The name of
// that object is the same as the stack's id.
stacks.stacks_in_38976_page10 = {};

// A closure is defined and assigned to the stack's object.  The object
// is also passed in as 'stack' which gives you a shorthand for referring
// to this object from elsewhere.
stacks.stacks_in_38976_page10 = (function(stack) {
 ...
 var opacity=100,opacityBottom=85,hoverOpacity=15,subNavIndex=1,divide=0,zoneDivider=0,fullWidthMenu='full-width',scope='all',style='solid',menuAlign='right',baseColor='#FFFFFF',baseColorTop='#737373',hoverColor='#FFFFFF',styleActive='styleActive'==='styleActive'?true:false,rwmenu='rw'==='rw'?true:false,magellan='rw'==='magellan'?true:false,menuItems='#stacks_in_38976_page10 ul:not(.title-area) li:hover:not(.has-dropdown) > a:not(.button)',dropdowns='#stacks_in_38976_page10 ul:not(.title-area) li.has-dropdown';if(opacity<100||style=="faded"){$.glass({colors:[baseColor,baseColorTop],gradient:style,opacity:[opacity,opacityBottom],selector:'#stacks_in_38976_page10 .top-bar-wrapper'});$.glass({colors:[baseColor],opacity:[opacity],selector:'#stacks_in_38976_page10 ul:not(.title-area) ul.dropdown'});}
if(hoverOpacity<100){if(styleActive){var active=magellan?'#stacks_in_38976_page10 .top-bar-wrapper.styleActive .magellanList li.active > a':'#stacks_in_38976_page10 .top-bar-wrapper.styleActive li.active > a';$.glass({colors:[hoverColor],opacity:[hoverOpacity],selector:active});}
$.glass({colors:[hoverColor],opacity:[hoverOpacity],selector:menuItems});$.glass({colors:[hoverColor],opacity:[hoverOpacity],selector:dropdowns+'> a.hovered:not(.button)'});}
$(document).ready(function(){var stack=$('#stacks_in_38976_page10');stack.parent().css({overflow:'visible'});$('.top-bar-section:not(.menu-magellan):not(.menu-none)',stack).rwflexnav({scope:scope,subNavIndex:subNavIndex,divide:divide});if(magellan){if(divide)$('ul.magellanList',stack).divideNav();$('.magellanList li',stack).each(function(){var id=$(this).data('magellan-arrival');$('a',this).attr('href','#'+id);});}
if($('ul.zone',stack).exists()){if(zoneDivider)$('ul.zone',stack).divideNav();}
if($('.zone-align-left ul.zone',stack).exists()||!$('ul.zone',stack).exists()){$('ul.menu',stack).addClass(menuAlign);}
if(fullWidthMenu==='full-width'&&menuAlign==='centered'){var calcMenuItemWidth=function(){var items=$('.menu-align-centered ul.menu > li:not(.divider)',stack),dividers=$('.menu-align-centered ul.menu > li.divider',stack);if($('.top-bar .toggle-topbar',stack).is(':visible')){items.removeAttr('style');}
else{var count=items.length;if(count>0){var width=dividers.length>0?100/count-0.2:100/count;items.width(width+"%");}}};calcMenuItemWidth();$(window).on('resize',calcMenuItemWidth);}
...
// Javascript for stacks_in_39003_page10
// ---------------------------------------------------------------------

// Each stack has its own object with its own namespace.  The name of
// that object is the same as the stack's id.
stacks.stacks_in_39003_page10 = {};

// A closure is defined and assigned to the stack's object.  The object
// is also passed in as 'stack' which gives you a shorthand for referring
// to this object from elsewhere.
stacks.stacks_in_39003_page10 = (function(stack) {
 ...
 var opacity=100,opacityBottom=85,hoverOpacity=15,subNavIndex=1,divide=0,zoneDivider=0,fullWidthMenu='full-width',scope='all',style='solid',menuAlign='right',baseColor='#FFFFFF',baseColorTop='#737373',hoverColor='#FFFFFF',styleActive='styleActive'==='styleActive'?true:false,rwmenu='rw'==='rw'?true:false,magellan='rw'==='magellan'?true:false,menuItems='#stacks_in_39003_page10 ul:not(.title-area) li:hover:not(.has-dropdown) > a:not(.button)',dropdowns='#stacks_in_39003_page10 ul:not(.title-area) li.has-dropdown';if(opacity<100||style=="faded"){$.glass({colors:[baseColor,baseColorTop],gradient:style,opacity:[opacity,opacityBottom],selector:'#stacks_in_39003_page10 .top-bar-wrapper'});$.glass({colors:[baseColor],opacity:[opacity],selector:'#stacks_in_39003_page10 ul:not(.title-area) ul.dropdown'});}
if(hoverOpacity<100){if(styleActive){var active=magellan?'#stacks_in_39003_page10 .top-bar-wrapper.styleActive .magellanList li.active > a':'#stacks_in_39003_page10 .top-bar-wrapper.styleActive li.active > a';$.glass({colors:[hoverColor],opacity:[hoverOpacity],selector:active});}
$.glass({colors:[hoverColor],opacity:[hoverOpacity],selector:menuItems});$.glass({colors:[hoverColor],opacity:[hoverOpacity],selector:dropdowns+'> a.hovered:not(.button)'});}
$(document).ready(function(){var stack=$('#stacks_in_39003_page10');stack.parent().css({overflow:'visible'});$('.top-bar-section:not(.menu-magellan):not(.menu-none)',stack).rwflexnav({scope:scope,subNavIndex:subNavIndex,divide:divide});if(magellan){if(divide)$('ul.magellanList',stack).divideNav();$('.magellanList li',stack).each(function(){var id=$(this).data('magellan-arrival');$('a',this).attr('href','#'+id);});}
if($('ul.zone',stack).exists()){if(zoneDivider)$('ul.zone',stack).divideNav();}
if($('.zone-align-left ul.zone',stack).exists()||!$('ul.zone',stack).exists()){$('ul.menu',stack).addClass(menuAlign);}
if(fullWidthMenu==='full-width'&&menuAlign==='centered'){var calcMenuItemWidth=function(){var items=$('.menu-align-centered ul.menu > li:not(.divider)',stack),dividers=$('.menu-align-centered ul.menu > li.divider',stack);if($('.top-bar .toggle-topbar',stack).is(':visible')){items.removeAttr('style');}
else{var count=items.length;if(count>0){var width=dividers.length>0?100/count-0.2:100/count;items.width(width+"%");}}};calcMenuItemWidth();$(window).on('resize',calcMenuItemWidth);}
...
// Javascript for stacks_in_7523_page10
// ---------------------------------------------------------------------

// Each stack has its own object with its own namespace.  The name of
// that object is the same as the stack's id.
stacks.stacks_in_7523_page10 = {};

// A closure is defined and assigned to the stack's object.  The object
// is also passed in as 'stack' which gives you a shorthand for referring
// to this object from elsewhere.
stacks.stacks_in_7523_page10 = (function(stack) {
...
// Javascript for stacks_in_7539_page10
// ---------------------------------------------------------------------

// Each stack has its own object with its own namespace.  The name of
// that object is the same as the stack's id.
stacks.stacks_in_7539_page10 = {};

// A closure is defined and assigned to the stack's object.  The object
// is also passed in as 'stack' which gives you a shorthand for referring
// to this object from elsewhere.
stacks.stacks_in_7539_page10 = (function(stack) {
 ...
 $(document).ready(function(){var movingbox=$('#stacks_in_7539_page10 >.movingbox'),effect='slide',fade=(effect=='fade')?true:false,vertical=(effect=='slide-vert')?true:false,initial=1-1,sync=0,autoplay=true,b1conf={breakpoint:480,settings:{slidesToShow:(effect=='fade')?1:1,slidesToScroll:1,initialSlide:1-1,centerMode:false,centerPadding:'%',dots:true,arrows:false}},b2conf={breakpoint:660,settings:{slidesToShow:(effect=='fade')?1:1,slidesToScroll:1,initialSlide:1-1,centerMode:false,centerPadding:'%',dots:true,arrows:false}},breakpoints=[];if(window.debug===true)autoplay=false;var slideTitles=[];movingbox.children().each(function(index){var title=index+1;var headers=$(this).find('h1,h2,h3,h4,h5,h6');if(headers.exists()){$.debug('Slide Headers',headers);title=headers.first().text().replace(/\s+/g,'-').toLowerCase();}
else{var images=$(this).find('img');if(images.exists()){$.debug('Slide Images',images);alt=images.first().attr('alt').replace(/\s+/g,'-').toLowerCase();title=alt!==''?alt:title;}}
$.debug('Slide Title #'+index+':'+title);slideTitles.push(title);});$.debug('All Slide Titles:',slideTitles);if(true)breakpoints.push(b1conf);if(false)breakpoints.push(b2conf);if(false){$('>.stacks_out',movingbox).each(function(){$(this).width($(this).width());});}
movingbox.slick({asNavFor:(0)?'#movingbox2':null,adaptiveHeight:false,variableWidth:false,accessibility:true,focusOnSelect:true,lazyLoad:'progressive',autoplay:autoplay,autoplaySpeed:4000,arrows:false,useCSS:true,cssEase:'ease',dots:true,draggable:true,fade:fade,vertical:vertical,infinite:true,pauseOnHover:false,pauseOnDotsHover:false,speed:500,swipe:true,touchMove:true,touchThreshold:5,rtl:false,slide:'.stacks_out',initialSlide:1-1,slidesToShow:(effect=='fade')?1:1,slidesToScroll:1,centerMode:false,centerPadding:'10.00%',responsive:breakpoints});var goToSlide=function(hash){var index=slideTitles.indexOf(hash);$.debug('Linking to hash '+hash+'with index '+index,slideTitles);if(index>=0){$.debug('Moving to slide with index '+index);movingbox.slickGoTo(parseInt(index)).slickPause();if(sync>0){$(window).load(function(){if($('#movingbox2').getSlick()){$('#movingbox2').slickGoTo(parseInt(index)).slickPause();}});}}};if(window.location.hash){var hash=location.hash.substring(1);goToSlide(hash);}
$('a.mb-slide').click(function(){var hash=$(this).attr('href').substring(1);goToSlide(hash);return false;});if($.isMobile()){$('.tap-target',movingbox).removeClass('hide').click(function(){$(this).hasClass('prev')?movingbox.slickPrev():movingbox.slickNext();})}});
...
// Javascript for stacks_in_7555_page10
// ---------------------------------------------------------------------

// Each stack has its own object with its own namespace.  The name of
// that object is the same as the stack's id.
stacks.stacks_in_7555_page10 = {};

// A closure is defined and assigned to the stack's object.  The object
// is also passed in as 'stack' which gives you a shorthand for referring
// to this object from elsewhere.
stacks.stacks_in_7555_page10 = (function(stack) {
...
// Javascript for stacks_in_7606_page10
// ---------------------------------------------------------------------

// Each stack has its own object with its own namespace.  The name of
// that object is the same as the stack's id.
stacks.stacks_in_7606_page10 = {};

// A closure is defined and assigned to the stack's object.  The object
// is also passed in as 'stack' which gives you a shorthand for referring
// to this object from elsewhere.
stacks.stacks_in_7606_page10 = (function(stack) {
 ...
 $(document).ready(function(){var movingbox=$('#stacks_in_7606_page10 >.movingbox'),effect='slide',fade=(effect=='fade')?true:false,vertical=(effect=='slide-vert')?true:false,initial=1-1,sync=0,autoplay=true,b1conf={breakpoint:480,settings:{slidesToShow:(effect=='fade')?1:1,slidesToScroll:1,initialSlide:1-1,centerMode:false,centerPadding:'%',dots:true,arrows:false}},b2conf={breakpoint:660,settings:{slidesToShow:(effect=='fade')?1:1,slidesToScroll:1,initialSlide:1-1,centerMode:false,centerPadding:'%',dots:true,arrows:false}},breakpoints=[];if(window.debug===true)autoplay=false;var slideTitles=[];movingbox.children().each(function(index){var title=index+1;var headers=$(this).find('h1,h2,h3,h4,h5,h6');if(headers.exists()){$.debug('Slide Headers',headers);title=headers.first().text().replace(/\s+/g,'-').toLowerCase();}
else{var images=$(this).find('img');if(images.exists()){$.debug('Slide Images',images);alt=images.first().attr('alt').replace(/\s+/g,'-').toLowerCase();title=alt!==''?alt:title;}}
$.debug('Slide Title #'+index+':'+title);slideTitles.push(title);});$.debug('All Slide Titles:',slideTitles);if(true)breakpoints.push(b1conf);if(false)breakpoints.push(b2conf);if(false){$('>.stacks_out',movingbox).each(function(){$(this).width($(this).width());});}
movingbox.slick({asNavFor:(0)?'#movingbox2':null,adaptiveHeight:false,variableWidth:false,accessibility:true,focusOnSelect:true,lazyLoad:'progressive',autoplay:autoplay,autoplaySpeed:4000,arrows:false,useCSS:true,cssEase:'ease',dots:true,draggable:true,fade:fade,vertical:vertical,infinite:true,pauseOnHover:false,pauseOnDotsHover:false,speed:500,swipe:true,touchMove:true,touchThreshold:5,rtl:false,slide:'.stacks_out',initialSlide:1-1,slidesToShow:(effect=='fade')?1:1,slidesToScroll:1,centerMode:false,centerPadding:'10.00%',responsive:breakpoints});var goToSlide=function(hash){var index=slideTitles.indexOf(hash);$.debug('Linking to hash '+hash+'with index '+index,slideTitles);if(index>=0){$.debug('Moving to slide with index '+index);movingbox.slickGoTo(parseInt(index)).slickPause();if(sync>0){$(window).load(function(){if($('#movingbox2').getSlick()){$('#movingbox2').slickGoTo(parseInt(index)).slickPause();}});}}};if(window.location.hash){var hash=location.hash.substring(1);goToSlide(hash);}
$('a.mb-slide').click(function(){var hash=$(this).attr('href').substring(1);goToSlide(hash);return false;});if($.isMobile()){$('.tap-target',movingbox).removeClass('hide').click(function(){$(this).hasClass('prev')?movingbox.slickPrev():movingbox.slickNext();})}});
...
// Javascript for stacks_in_7624_page10
// ---------------------------------------------------------------------

// Each stack has its own object with its own namespace.  The name of
// that object is the same as the stack's id.
stacks.stacks_in_7624_page10 = {};

// A closure is defined and assigned to the stack's object.  The object
// is also passed in as 'stack' which gives you a shorthand for referring
// to this object from elsewhere.
stacks.stacks_in_7624_page10 = (function(stack) {
 ...
 $(document).ready(function(){var movingbox=$('#stacks_in_7624_page10 >.movingbox'),effect='slide',fade=(effect=='fade')?true:false,vertical=(effect=='slide-vert')?true:false,initial=1-1,sync=0,autoplay=true,b1conf={breakpoint:480,settings:{slidesToShow:(effect=='fade')?1:1,slidesToScroll:1,initialSlide:1-1,centerMode:false,centerPadding:'%',dots:true,arrows:false}},b2conf={breakpoint:660,settings:{slidesToShow:(effect=='fade')?1:1,slidesToScroll:1,initialSlide:1-1,centerMode:false,centerPadding:'%',dots:true,arrows:false}},breakpoints=[];if(window.debug===true)autoplay=false;var slideTitles=[];movingbox.children().each(function(index){var title=index+1;var headers=$(this).find('h1,h2,h3,h4,h5,h6');if(headers.exists()){$.debug('Slide Headers',headers);title=headers.first().text().replace(/\s+/g,'-').toLowerCase();}
else{var images=$(this).find('img');if(images.exists()){$.debug('Slide Images',images);alt=images.first().attr('alt').replace(/\s+/g,'-').toLowerCase();title=alt!==''?alt:title;}}
$.debug('Slide Title #'+index+':'+title);slideTitles.push(title);});$.debug('All Slide Titles:',slideTitles);if(true)breakpoints.push(b1conf);if(false)breakpoints.push(b2conf);if(false){$('>.stacks_out',movingbox).each(function(){$(this).width($(this).width());});}
movingbox.slick({asNavFor:(0)?'#movingbox2':null,adaptiveHeight:false,variableWidth:false,accessibility:true,focusOnSelect:true,lazyLoad:'progressive',autoplay:autoplay,autoplaySpeed:4000,arrows:false,useCSS:true,cssEase:'ease',dots:true,draggable:true,fade:fade,vertical:vertical,infinite:true,pauseOnHover:false,pauseOnDotsHover:false,speed:500,swipe:true,touchMove:true,touchThreshold:5,rtl:false,slide:'.stacks_out',initialSlide:1-1,slidesToShow:(effect=='fade')?1:1,slidesToScroll:1,centerMode:false,centerPadding:'10.00%',responsive:breakpoints});var goToSlide=function(hash){var index=slideTitles.indexOf(hash);$.debug('Linking to hash '+hash+'with index '+index,slideTitles);if(index>=0){$.debug('Moving to slide with index '+index);movingbox.slickGoTo(parseInt(index)).slickPause();if(sync>0){$(window).load(function(){if($('#movingbox2').getSlick()){$('#movingbox2').slickGoTo(parseInt(index)).slickPause();}});}}};if(window.location.hash){var hash=location.hash.substring(1);goToSlide(hash);}
$('a.mb-slide').click(function(){var hash=$(this).attr('href').substring(1);goToSlide(hash);return false;});if($.isMobile()){$('.tap-target',movingbox).removeClass('hide').click(function(){$(this).hasClass('prev')?movingbox.slickPrev():movingbox.slickNext();})}});
...
// Javascript for stacks_in_7642_page10
// ---------------------------------------------------------------------

// Each stack has its own object with its own namespace.  The name of
// that object is the same as the stack's id.
stacks.stacks_in_7642_page10 = {};

// A closure is defined and assigned to the stack's object.  The object
// is also passed in as 'stack' which gives you a shorthand for referring
// to this object from elsewhere.
stacks.stacks_in_7642_page10 = (function(stack) {
 ...
 $(document).ready(function(){var movingbox=$('#stacks_in_7642_page10 >.movingbox'),effect='slide',fade=(effect=='fade')?true:false,vertical=(effect=='slide-vert')?true:false,initial=1-1,sync=0,autoplay=true,b1conf={breakpoint:480,settings:{slidesToShow:(effect=='fade')?1:1,slidesToScroll:1,initialSlide:1-1,centerMode:false,centerPadding:'%',dots:true,arrows:false}},b2conf={breakpoint:660,settings:{slidesToShow:(effect=='fade')?1:1,slidesToScroll:1,initialSlide:1-1,centerMode:false,centerPadding:'%',dots:true,arrows:false}},breakpoints=[];if(window.debug===true)autoplay=false;var slideTitles=[];movingbox.children().each(function(index){var title=index+1;var headers=$(this).find('h1,h2,h3,h4,h5,h6');if(headers.exists()){$.debug('Slide Headers',headers);title=headers.first().text().replace(/\s+/g,'-').toLowerCase();}
else{var images=$(this).find('img');if(images.exists()){$.debug('Slide Images',images);alt=images.first().attr('alt').replace(/\s+/g,'-').toLowerCase();title=alt!==''?alt:title;}}
$.debug('Slide Title #'+index+':'+title);slideTitles.push(title);});$.debug('All Slide Titles:',slideTitles);if(true)breakpoints.push(b1conf);if(false)breakpoints.push(b2conf);if(false){$('>.stacks_out',movingbox).each(function(){$(this).width($(this).width());});}
movingbox.slick({asNavFor:(0)?'#movingbox2':null,adaptiveHeight:false,variableWidth:false,accessibility:true,focusOnSelect:true,lazyLoad:'progressive',autoplay:autoplay,autoplaySpeed:4000,arrows:false,useCSS:true,cssEase:'ease',dots:true,draggable:true,fade:fade,vertical:vertical,infinite:true,pauseOnHover:false,pauseOnDotsHover:false,speed:500,swipe:true,touchMove:true,touchThreshold:5,rtl:false,slide:'.stacks_out',initialSlide:1-1,slidesToShow:(effect=='fade')?1:1,slidesToScroll:1,centerMode:false,centerPadding:'10.00%',responsive:breakpoints});var goToSlide=function(hash){var index=slideTitles.indexOf(hash);$.debug('Linking to hash '+hash+'with index '+index,slideTitles);if(index>=0){$.debug('Moving to slide with index '+index);movingbox.slickGoTo(parseInt(index)).slickPause();if(sync>0){$(window).load(function(){if($('#movingbox2').getSlick()){$('#movingbox2').slickGoTo(parseInt(index)).slickPause();}});}}};if(window.location.hash){var hash=location.hash.substring(1);goToSlide(hash);}
$('a.mb-slide').click(function(){var hash=$(this).attr('href').substring(1);goToSlide(hash);return false;});if($.isMobile()){$('.tap-target',movingbox).removeClass('hide').click(function(){$(this).hasClass('prev')?movingbox.slickPrev():movingbox.slickNext();})}});
...
// Javascript for stacks_in_25258_page10
// ---------------------------------------------------------------------

// Each stack has its own object with its own namespace.  The name of
// that object is the same as the stack's id.
stacks.stacks_in_25258_page10 = {};

// A closure is defined and assigned to the stack's object.  The object
// is also passed in as 'stack' which gives you a shorthand for referring
// to this object from elsewhere.
stacks.stacks_in_25258_page10 = (function(stack) {
 ...
 $(document).ready(function(){var stack=$('#stacks_in_25258_page10');$('ul',stack).first().addClass('side-nav custom').removeClass('dropdown');$('ul li',stack).each(function(){if($(this).find('ul').length==0)$(this).removeClass('has-dropdown');});$('ul.side-nav li a header',stack).unwrap().parent().addClass('heading');$('ul.side-nav li a label',stack).unwrap();$('ul.side-nav li a hr',stack).unwrap().parent().addClass('divider').html('');});
